...
/**
 * הוכחת נכונות:
 * ניקח קודם כל את המקסימום בין האיבר הראשון בa לאיבר האחרון בb
 * מכיוון שהמערכים ממויינים נחלק את זה לשתי אפשרויות:
 *
 * אם האיבר הראשון בa גדול מהאיבר האחרון בb :
 * לפי תכונת הטרנזטיביות נקבל שכל האיברים בa הם גדולים מהחציון
 *
 *
 * אם האיבר הראשון בa קטן מהאיבר האחרון בb :
 * אז כל האיברים בb גולים מהחציון
 *
 * ןכך נמשיך לבדוק את המערך בלי האיבר הראשון בa והאיבר האחרון בb
 */
