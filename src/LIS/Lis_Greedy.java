...
/**
 *סיבוכיות השיטה:
 *נכונות השיטה: כפי שניתן לראות, השיטה עדיין לא החזירה את התשובה הנכונה כי לא פתרנו
 * את הבעיה שלפעמים כדאי לוותר על מספר איברים כדי לקחת אחרים טובים יותר.
 *
 * O(n^2)
 *
 *
 * by lcs:
 * נכונות השיטה: מכיוון שהמטרה היא למצוא תת סדרה עולה ארוכה ביותר אז בהכרח התשובה
 * היא תת סדרה של המערך הממוין כך ששומרים על סדר האיברים במערך ולכן תת הסדרה
 * המשותפת בין 2 המערכים היא בדיוק התשובה.
 */
