...
/**
 * הוכחת נכונות:
 * נבחר במחרוזת הקצרה יותר ועליה נבנה מערך מונים
 * לאחר מכן נעבור על המחרוזת הגדולה יותר וכאשר נמצא אות שנמצאת במערך המונים וגדולה מאפס נוסיף אותה לפתרון שלנו ונחסר מהכמות שלה ב1
 *סיבוכיות של O(n+m)
 */
